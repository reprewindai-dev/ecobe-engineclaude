# CO2 Router Public Documentation

This folder contains material safe to share publicly. It is intentionally
high-level and does not disclose proprietary implementation details.
