...
ADD CONSTRAINT "DoctrineProposal_approved_requires_distinct_approver_chk"
CHECK (
    "status" <> 'APPROVED'
    OR (
        "approverOperatorId" IS NOT NULL
        AND "approverOperatorId" <> "proposerOperatorId"
    )
);

ALTER TABLE "DoctrineVersion"
ADD CONSTRAINT "DoctrineVersion_distinct_approver_chk"
CHECK (
    "approvedByOperatorId" IS NULL
    OR "approvedByOperatorId" <> "proposedByOperatorId"
);
...
CREATE UNIQUE INDEX "Operator_id_orgId_key" ON "Operator"("id", "orgId");
...
CREATE UNIQUE INDEX "DoctrineProposal_id_orgId_key" ON "DoctrineProposal"("id", "orgId");

CREATE UNIQUE INDEX "DoctrineVersion_sourceProposalId_key" ON "DoctrineVersion"("sourceProposalId");
CREATE UNIQUE INDEX "DoctrineVersion_id_orgId_key" ON "DoctrineVersion"("id", "orgId");
...
ALTER TABLE "DoctrineProposal"
ADD CONSTRAINT "DoctrineProposal_proposerOperatorId_fkey" FOREIGN KEY ("proposerOperatorId", "orgId") REFERENCES "Operator"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "DoctrineProposal"
ADD CONSTRAINT "DoctrineProposal_approverOperatorId_fkey" FOREIGN KEY ("approverOperatorId", "orgId") REFERENCES "Operator"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "DoctrineVersion"
ADD CONSTRAINT "DoctrineVersion_sourceProposalId_fkey" FOREIGN KEY ("sourceProposalId", "orgId") REFERENCES "DoctrineProposal"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "DoctrineVersion"
ADD CONSTRAINT "DoctrineVersion_proposedByOperatorId_fkey" FOREIGN KEY ("proposedByOperatorId", "orgId") REFERENCES "Operator"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "DoctrineVersion"
ADD CONSTRAINT "DoctrineVersion_approvedByOperatorId_fkey" FOREIGN KEY ("approvedByOperatorId", "orgId") REFERENCES "Operator"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "DoctrineVersion"
ADD CONSTRAINT "DoctrineVersion_rolledBackFromVersionId_fkey" FOREIGN KEY ("rolledBackFromVersionId", "orgId") REFERENCES "DoctrineVersion"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "DoctrineAuditEvent"
ADD CONSTRAINT "DoctrineAuditEvent_actorOperatorId_fkey" FOREIGN KEY ("actorOperatorId", "orgId") REFERENCES "Operator"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "DoctrineAuditEvent"
ADD CONSTRAINT "DoctrineAuditEvent_proposalId_fkey" FOREIGN KEY ("proposalId", "orgId") REFERENCES "DoctrineProposal"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "DoctrineAuditEvent"
ADD CONSTRAINT "DoctrineAuditEvent_versionId_fkey" FOREIGN KEY ("versionId", "orgId") REFERENCES "DoctrineVersion"("id", "orgId") ON DELETE RESTRICT ON UPDATE CASCADE;
