...
const envSchema = z.object({
  ...
  UPSTASH_SEARCH_REST_URL: z.string().optional(),
  UPSTASH_SEARCH_REST_TOKEN: z.string().optional(),
  UPSTASH_SEARCH_INDEX_NAME: z.string().optional(),
  ...
  EU_EAST_1_QSTASH_URL: z.string().optional(),
  EU_EAST_1_QSTASH_TOKEN: z.string().optional(),
  EU_EAST_1_QSTASH_CURRENT_SIGNING_KEY: z.string().optional(),
  EU_EAST_1_QSTASH_NEXT_SIGNING_KEY: z.string().optional(),
