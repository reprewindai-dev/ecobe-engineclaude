...
export const telemetryMetricNames = {
  ...
  authorizationArtifactSnapshotLatencyMs: 'ecobe.authorization.artifact_snapshot.latency.ms',
  authorizationCandidateEvaluationLatencyMs: 'ecobe.authorization.candidate_evaluation.latency.ms',
  authorizationPolicyHookLatencyMs: 'ecobe.authorization.policy_hook.latency.ms',
  authorizationDoctrineAssemblyLatencyMs: 'ecobe.authorization.doctrine_assembly.latency.ms',
  authorizationTraceAssemblyLatencyMs: 'ecobe.authorization.trace_assembly.latency.ms',
