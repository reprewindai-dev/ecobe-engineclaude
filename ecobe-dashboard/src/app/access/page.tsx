    ...
    <div className="space-y-8 pb-10">
      ...
      <section className="surface-card p-6">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          <Link href="/contact" className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-5 py-3 text-sm font-semibold text-cyan-200 transition hover:border-cyan-300/30 hover:bg-cyan-300/15 hover:text-white">
