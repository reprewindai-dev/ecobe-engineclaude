  ...
  try {
    ...
    res.json({
      ...
      cache: {
        ...
        requiredDefensibleWarmCoveragePct: cacheHealth.requiredDefensibleWarmCoveragePct,
        requiredFallbackWarmCoveragePct: cacheHealth.requiredFallbackWarmCoveragePct,
        requiredDefensibleLkgCoveragePct: cacheHealth.requiredDefensibleLkgCoveragePct,
        requiredFallbackLkgCoveragePct: cacheHealth.requiredFallbackLkgCoveragePct,
        requiredRegions: cacheHealth.requiredRegions,
